...
public class Garapon implements GaraponApi {

	public GaraponSettings settings;
	public ObjectMapper mapper;
	private static Garapon instance = new Garapon();

	private Garapon() {
	}

	public static Garapon getInstance() {
		return instance;
	}
	...
	public static class SearchBuilder {
		...
		public ArrayList<ProgramInfo> execute() {
			...
			ObjectMapper mapper = Garapon.getInstance().mapper;
			try {
				search = mapper.readValue(resultJsonString.getBytes(),
						SearchResult.class);
				result = search.getProgram();
